...
$$
\begin{aligned} R &= \texttt{final\_value}(s, \{z_\ell\}_{\ell=1}^L) \\ &=\mathrm{eCPM}(s, \{z_\ell\}_{\ell=1}^L) + \,\frac{1}{N}\sum_{i=1}^{N}\alpha_i\,\mathrm{target}_i(s, \{z_\ell\}_{\ell=1}^L), \end{aligned}
$$
